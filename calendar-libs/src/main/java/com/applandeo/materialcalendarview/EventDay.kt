...
data class EventDay(val calendar: Calendar) {
    ...
    internal var liveEventName: List<String> = ArrayList()

    internal var labelColor: Int = 0
    internal var tanggal:String = ""
    internal var bulan:String = ""
    internal var callbackDayClick: DayClick? = null
    ...
    constructor(day: Calendar, drawable: Drawable, tanggal:String, bulan:String, callback:DayClick) : this(day) {
        imageDrawable = EventImage.EventImageDrawable(drawable)
        this.bulan = bulan
        this.tanggal = tanggal
        this.callbackDayClick = callback
    }

    constructor(day: Calendar, eventName: ArrayList<String>, tanggal:String, bulan:String, callback:DayClick) : this(day) {
        this.liveEventName = eventName
    ...
    constructor(day: Calendar, eventName: ArrayList<String>, drawable: Drawable, tanggal:String, bulan:String, callback:DayClick) : this(day) {
        this.liveEventName = eventName
        imageDrawable = EventImage.EventImageDrawable(drawable)
        this.bulan = bulan
        this.tanggal = tanggal
