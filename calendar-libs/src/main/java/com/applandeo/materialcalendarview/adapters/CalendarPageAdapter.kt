...
class CalendarPageAdapter(
    ...
    private lateinit var binding: CalendarViewGridBinding
    ...
    override fun instantiateItem(container: ViewGroup, position: Int): Any {
        binding = CalendarViewGridBinding.inflate(LayoutInflater.from(context))

        loadMonth(position)

        binding.calendarGridView.onItemClickListener = DayRowClickListener(this, calendarProperties, pageMonth)

        binding.calendarGridView.onItemLongClickListener = DayRowLongClickListener(calendarProperties)

        container.addView(binding.calendarGridView)
    ...
    private fun loadMonth(position: Int) {
        ...
        informDatePicker()
        binding.calendarGridView.adapter = calendarDayAdapter
    }
