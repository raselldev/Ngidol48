...
class CalendarDayAdapter(
    ...
    override fun getView(position: Int, view: View?, parent: ViewGroup): View {
        val binding = view?.tag as? CalendarViewDayBinding ?: CalendarViewDayBinding.inflate(
            LayoutInflater.from(context), parent, false)
        val day = GregorianCalendar().apply { time = getItem(position) }

        binding.dayIcon.visibility = View.GONE
        binding.imgSize.loadIcon(day)
        binding.rvEvent.loadEventName(day)
