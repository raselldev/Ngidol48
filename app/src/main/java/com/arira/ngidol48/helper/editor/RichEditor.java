package com.arira.ngidol48.helper.editor;
...
public class RichEditor extends WebView {
  ...
  public interface OnDecorationStateListener {
    ...
    void onStateChangeListener(String text, java.util.List<Type> types);
  }
  ...
  private void stateCheck(String text) {
    String state = text.replaceFirst(STATE_SCHEME, "").toUpperCase(java.util.Locale.ENGLISH);
