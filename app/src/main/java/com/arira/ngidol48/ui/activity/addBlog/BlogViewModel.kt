...
class BlogViewModel : ViewModel() {
    ...
    fun delete(id: String){
        ...
        subscription = repo.deleteBlog(id)
    ...
    fun add(judul: String, blog:String, kategoriId:String){

        subscription = repo.addBlog(pref.getUser().id, judul, blog, kategoriId)
            .subscribeOn(Schedulers.io())
            .observeOn(AndroidSchedulers.mainThread())
            .doOnSubscribe { isLoading.value = true }
            .doOnTerminate { isLoading.value = false }
    ...
    fun add(cover: File, judul:String, blog:String, kategoriId:String) {
        ...
        val partKategori = kategoriId.toRequestBody("text/plain".toMediaTypeOrNull())
        subscription = repo.addBlog(partCover, partIdUser, partIdJudul, partBlog, partKategori)
            .subscribeOn(Schedulers.io())
            .observeOn(AndroidSchedulers.mainThread())
            .doOnSubscribe { isLoading.value = true }
            .doOnTerminate { isLoading.value = false }
