...
class BlogKategoriViewModel : ViewModel() {

    private lateinit var subscription: Disposable
    var context: Context? = null
    var repo = BlogRepo()
    val data = MutableLiveData<BlogKategoriResponse>()
    ...
    fun getResponse(): LiveData<BlogKategoriResponse> {
        return data
    }

    fun hitAll() {
        subscription = repo.kategori()
