...
import com.arira.ngidol48.repo.NotifikasiRepo
...
class NotifikasiViewModel : ViewModel() {
    ...
    var repo = NotifikasiRepo()
    val data = MutableLiveData<NotifikasiResponse>()
    ...
    fun getResponse(): LiveData<NotifikasiResponse> {
        return data
    }
