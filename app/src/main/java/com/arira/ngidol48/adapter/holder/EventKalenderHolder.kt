...
import com.arira.ngidol48.databinding.ItemEventKalenderBinding
...
class EventKalenderHolder(var item:ItemEventKalenderBinding): RecyclerView.ViewHolder(item.root) {
    ...
    fun setData(data: Event){
        ...
        item.tvJam.text = data.event_time
