...
class MemberAdapter(var list:List<Member>, val callback: MemberCallback, var showtime:Boolean = false, var titleWhite:Boolean = false): RecyclerView.Adapter<MemberHolder>() {
    ...
    override fun onBindViewHolder(holder: MemberHolder, position: Int) {
        holder.setData(list[position], callback, showtime, titleWhite)
    }
